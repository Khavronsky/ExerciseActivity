...
import com.khavronsky.exerciseactivity.adapters.AdapterToRecentExerciseRecycler;
...
import static com.khavronsky.exerciseactivity.R.id.recent_exercise_custom_list;
...
public class RecentExercisesFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable final ViewGroup container,
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(recent_exercise_custom_list);
